...
class AreaReportDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('date',function($delivery_address){
                return getDateColumn($delivery_address,'created_at');
            })
            
            ->editColumn('orders', function ($delivery_address) {
                $orderlist = Order::where('delivery_address_id', '=', $delivery_address->delivery_address_id)->get();
    ...
    public function query(DeliveryAddress $model)
    {
        ...
        ->join('orders', 'orders.delivery_address_id', '=', 'delivery_addresses.id' )
        ->selectRaw('delivery_addresses.id,delivery_addresses.address,orders.delivery_address_id,orders.created_at')->groupBy('delivery_addresses.address');
