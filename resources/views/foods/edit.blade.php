    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">{{trans('lang.dish_edit')}}</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        @can('foods.index')
        <li class="nav-item">
          <a class="nav-link" href="{!! route('foods.index') !!}"><i class="fa fa-list mr-2"></i>{{trans('lang.menu_table')}}</a>
        </li>
        @endcan
        @can('foods.create')
        <li class="nav-item">
        ...
        @endcan
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-pencil mr-2"></i>{{trans('lang.dish_edit')}}</a>
        </li>
      </ul>
    </div>
    <div class="card-body">
